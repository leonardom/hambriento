                    ...
                    <div class="control-group">
                          ...
                          <div class="controls">
                            <label class="radio inline" for="radios-0">
                              <input type="radio" name="radios" id="radios-0" value="1" onclick="abreFormFinanceiro()" >
                                     <img src="img/visa.ico">
                            </label>
                            <label class="radio inline" for="radios-1">
                              <input type="radio" name="radios" id="radios-1" value="2" onclick="abreFormFinanceiro()">
